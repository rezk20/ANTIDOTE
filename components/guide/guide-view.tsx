...
export function GuideView() {
  ...
  const allPages = useMemo<GuidePageItem[]>(() => [
    ...
    },
    {
      ...
      href: "/agent",
      icon: Bot,
      titleAr: "الوكيل الذكي (Hermes AI)",
      titleEn: "Autonomous AI Copilot",
      pillar: "command",
      purposeAr: "لوحة تحكم الوكيل الخارجي، إدارة الـ API Keys، وتجربة الأوامر في الـ Playground.",
      purposeEn: "Manage API credentials, test tools in the interactive playground, and copy prompts.",
      stepsAr: [
        "انسخ مفتاح الـ API الخاص بك (`lsk_...`).",
        "انسخ الـ Master System Prompt وضعه في إعدادات وكيلك الذكي (مثل Hermes أو OpenClaw).",
        "جرب إرسال أمر فكرة سريعة أو تسجيل وقت عمل من الـ Playground للتأكد من الاتصال.",
      ],
      stepsEn: [
        "Copy your personal private Bearer API key (`lsk_...`).",
        "Copy the Master System Prompt and configure your external agent.",
        "Test thought capture or time logging actions in the built-in browser playground.",
      ],
      goldenRuleAr: "وكيلك الذكي يعمل كامتداد لعقلك، يوثق وينظم بياناتك بدون أن يقطع تركيزك.",
      goldenRuleEn: "Your AI agent operates as an autonomous extension of your mind, logging work in the background.",
    },
  ], []);
